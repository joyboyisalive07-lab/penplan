...
**Повтор обрывается на середине.** Некоторые холсты хранят для показа только
ограниченное число штрихов. Дальше рисунок по-прежнему появляется на вашем
экране, но уже не записывается. Впишите это число в **Stroke limit**, и
планировщик будет ухудшать план, пока не влезет, — так же, как он делает это со
временем.
